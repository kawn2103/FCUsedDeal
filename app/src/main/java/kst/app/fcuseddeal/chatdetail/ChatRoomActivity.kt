...
import kst.app.fcuseddeal.DBKey.Companion.DB_CHATS
...
class ChatRoomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_caht_room)
        ...
        findViewById<Button>(R.id.sendBt).setOnClickListener {
            val chatItem = ChatItem(
                ...
                message = findViewById<EditText>(R.id.messageEt).text.toString()
            )
